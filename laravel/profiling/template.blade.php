...
<div class="anbu">
	<div class="anbu-window">
		<div class="anbu-content-area">
			...
			<div class="anbu-tab-pane anbu-table anbu-cache">
				@if (count($cache_queries) > 0)
					<table>
						<tr>
							<th>Time</th>
							<th>Key</th>
				...
				@else
					<span class="anbu-empty">There have been no Cache queries executed.</span>
				@endif
			</div>
		</div>
	</div>
	...
	<ul id="anbu-open-tabs" class="anbu-tabs">
		...
		<li>
			<a data-anbu-tab="anbu-cache" class="anbu-tab" href="#">Cache 
				<span class="anbu-count">{{ count($cache_queries) }}</span>
				@if (count($cache_queries))
				<span class="anbu-count">{{ array_sum(array_map(function($q) { return $q[2]; }, $cache_queries)) }}ms</span>
				@endif
			</a>
		</li>
		<li><a data-anbu-tab="anbu-log" class="anbu-tab" href="#">Time <span class="anbu-count"><?php echo number_format((microtime(true) - LARAVEL_START) * 1000)?> ms</span></a></li>
