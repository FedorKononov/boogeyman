...
class Profiler {
	...
	/**
	 * Add a performed Cache query to the Profiler.
	 *
	 * @param 	string 	$key
	 * @param 	array 	$value
	 * @param 	float 	$time
	 * @return 	void
	 */
	public static function cache_query($key, $value, $time)
	{
		static::$data['cache_queries'][] = array($key, $value, $time);
	}
	...
	public static function attach()
	{
		...
		Event::listen('laravel.cache_query', function($key, $value, $time)
		{
			Profiler::cache_query($key, $value, $time);
		});
