...
Autoloader::namespaces(array('App' => path('app')));
...
/*
|--------------------------------------------------------------------------
| Register our auth driver
|--------------------------------------------------------------------------
| 
| Register custom auth driver
*/

Auth::extend('App\Libs\AccountAuth', function() {
	return new App\Libs\AccountAuth;
});