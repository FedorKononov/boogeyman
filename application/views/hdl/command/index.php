			...
			<tbody>
				<?foreach ($items->results as $item):?>
					<tr>
						...
						<td><a class="btn" href="/hdl/command/edit/<?= $item->id?>"><i class="icon-edit"></i> редактировать</a></td>
					</tr>
				<?endforeach;?>
			</tbody>
		</table>
		<?=$items->links(); ?>
		<a class="btn btn-primary" href="/hdl/command/create"><i class="icon-edit icon-white"></i> добавить</a>
	</div>
